...
before:
  summary: "Tangled state scattered across the component tree"
  points:
    - "useState calls everywhere"
    - "Prop drilling 4 levels deep"
    - "Changing a dropdown broke undo"
after:
  summary: "Four focused Context providers with clear domain boundaries"
  points:
    - "Each context owns its domain completely"
    - "135 tests, all passing"
    - "New features no longer feel like defusing a bomb"
---
