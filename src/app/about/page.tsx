  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="prose mt-8">
        <p>
          I&apos;m YoYu Chen, a software engineer based in Taiwan. My mission is
          simple: <strong>solve problems</strong>.
        </p>

        <p>
          I build the tools that teams rely on every day. My work spans the full
          stack — from interactive, performance-sensitive browser interfaces to
          server-side rendering pipelines — but it always starts with the same
          question: <em>what&apos;s the actual problem here?</em>
        </p>
        ...
        <p>
          ...
          the boundaries of what browsers can do. Think real-time collaboration,
          sophisticated state management, timeline-based interfaces, and
          pixel-perfect rendering — all running smoothly in the browser.
        </p>
        <p>
        ...
        <p>
          ...
          problem. I write code that future developers (including future me) can
          read and reason about.
        </p>

        <h2>How I Work</h2>
        <p>
          I&apos;m not married to any particular technology. My primary stack is
          TypeScript, React, Next.js, and Node.js, but I reach for whatever tool
          best fits the problem. I&apos;ve learned that the most valuable skill
          in software engineering isn&apos;t knowing a framework — it&apos;s
          knowing how to break down a messy problem into clear, solvable pieces.
        </p>
